...
public class IntHistogramTest {
  ...
  /**
   * Test to confirm that the IntHistogram implementation is constant-space (or, at least,
   * reasonably small space; O(log(n)) might still work if your constants are good).
   */
  @Test
